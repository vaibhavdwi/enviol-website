      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-3 flex justify-between items-center">
        ...
        <Link href="/" className="flex flex-col">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative animate-logoFloat">
              ...
              <div className="absolute inset-0 rounded-full bg-[#5ffbf1]/20 blur-xl animate-logoPulse">
              </div>
          ...
          <div className="pl-[8px] mt-1">
            ...
            <AnimatedTagline
              text="Reuse waste to Sustainable Polyurethanes"
            />
        ...
        <nav className="hidden md:flex items-center gap-8 text-base md:text-lg font-medium text-[#d8f3f1]">
          ...
          >
            ...
            <span className="absolute inset-0 rounded-full animate-contactPulse border border-white/30">
            </span>
