...
export default function TechnicalBlogsPage() {
  ...
  const latestBlogs = [...technicalBlogs]
    .slice(0, 10);
      ...
      <section className="pt-20 pb-10 border-b">
        ...
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="max-w-3xl mx-auto text-lg text-gray-700">
            Explore in-depth technical articles on polyurethane
            chemistry, polyester polyols, polyether polyols,
            rigid foam technologies, PIR insulation, PUF systems,
            CASE applications and sustainable chemical recycling.
          </p>
