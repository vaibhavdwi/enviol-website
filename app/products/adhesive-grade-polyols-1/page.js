...
export default function AdhesiveGradePolyolsPage() {
  const adhesiveProducts = products.filter(
    (p) => p.category === "Adhesive Grade Polyols"
  );
      ...
      <div className="container mx-auto px-6 py-12 pt-20 pb-12">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          <div className="md:w-1/2">
            ...
            <AnimatedHeading title="Adhesive Grade Polyols" />
          ...
          <div className="md:w-1/2 flex justify-center md:justify-end">
            ...
            <div className="w-full max-w-md rounded-xl overflow-hidden shadow-lg border border-gray-200">
              ...
              <Image
                src="/images/adhesive-polyols.jpg"   // 🔁 replace image
                alt="Adhesive Grade Polyols"
                width={600}
                height={400}
